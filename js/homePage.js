window.onload = function () {
	...
	addBanner("img/banners/banner1.jpg", "img/banners/banner1.jpg");
	var numBanner = 8;
	...
	var company = ["Apple.jpg", "Samsung.jpg", "Oppo.jpg", "Xiaomi.jpg", "Honor.jpg", "Realme.jpg",
		"Vivo.jpg", "Asus.jpg", "Masstel.jpg", "Nokia.jpg"
	];
	...
	if (filters.length) {
		...
		var soLuong = (window.innerWidth < 1200 ? 6 : 8);
		...
		addKhungSanPham('GIÁ SỐC', green, ['promo=giare', 'sort=rateCount-decrease'], soLuong, div);
...
var soLuongSanPhamMaxTrongMotTrang = 16;
