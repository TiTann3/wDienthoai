	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="news.html"><i class="fa fa-newspaper-o"></i> Tin tức</a></li>
                <li><a href="introduce.html"><i class="fa fa-info-circle"></i> Giới thiệu</a></li>
                <li><a href="serviceCenter.html"><i class="fa fa-wrench"></i> Bảo hành</a></li>
                <li><a href="contact.html"><i class="fa fa-phone"></i> Liên hệ</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/icon.png" alt="Trang chủ TTP Shop" title="Trang chủ TTP Shop">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="users.html">Trang người dùng</a>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">TTP Shop</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">TTP Shop</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #288ad6;">012 345 678</a>
                </li>
            </ul>
        </section>
    </div>`);
